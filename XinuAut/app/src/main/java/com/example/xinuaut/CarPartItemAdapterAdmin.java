...
public class CarPartItemAdapterAdmin extends RecyclerView.Adapter<CarPartItemAdapterAdmin.ViewHolder> implements Filterable {

    private ArrayList carpartItemData;
    private ArrayList<CarPartItem> carpartItemDataAll;
    private Context context;

    public CarPartItemAdapterAdmin(Context context, ArrayList<CarPartItem> itemsData) {
        ...
        public void bindTo(CarPartItem current) {
            ...
            itemView.findViewById(R.id.cart).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((CarPartsActivityAdmin) context).updateAlertIcon(current);
                }
            });
            ...
            itemView.findViewById(R.id.update).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((CarPartsActivityAdmin) context).updatePart(current);
                }
            });
            ...
            itemView.findViewById(R.id.delete).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((CarPartsActivityAdmin) context).deleteCarPart(current);
                }
            });
        }
    }
